...
<td align="center"><a href="index.php?a=admin&amp;b=edit_review&id={$id}">{$LNG['a_man_edit']}</a></td>
<td align="center"><a href="index.php?a=admin&amp;b=delete_review&id={$id}">{$LNG['a_man_delete']}</a></td>
</tr>
EndHTML;
