...
$LNG['g_form_submit_reset'] = "Resetear";
$LNG['g_id'] = "ID";
$LNG['g_url'] = "URL";
$LNG['g_title'] = "Título";
...
$LNG['g_this_month'] = "Este mes"; // 3.2.1
$LNG['g_last_month'] = "Mes pasado"; // 3.2.1
$LNG['g_this_week'] = "Esta semana"; // 4.2.0
$LNG['g_last_week'] = "Semana pasada"; // 4.2.0
$LNG['g_unq_pv'] = "Visitas Únicas";
$LNG['g_tot_pv'] = "Visitas Totales";
$LNG['g_unq_in'] = "Hits Únicos de Entrada";
$LNG['g_tot_in'] = "Hits Totales de Entrada";
$LNG['g_unq_out'] = "Hits Únicos de Salida";
$LNG['g_tot_out'] = "Hits Totales de Salida";
...
$LNG['edit_error_id_password'] = "Por favor revisa tu número ID y tu contraseña e inténtalo de nuevo.";
$LNG['edit_error'] = "Error";
$LNG['edit_error_forgot'] = "Olvidaste:";
$LNG['edit_error_url'] = "Colocar una URL válida.";
$LNG['edit_error_email'] = "Colocar una dirección de correo válida.";
$LNG['edit_error_title'] = "Escribe un título para tu sitio web.";
$LNG['edit_error_password'] = "Escoger contraseña.";
$LNG['edit_error_back'] = "Por favor vuelve atrás y llena los campos necesarios.";
$LNG['edit_success'] = "¡Éxito!";
...
$LNG['join_error_forgot'] = "Olvidaste:";
...
$LNG['join_error_urlbanner'] = "Colocar un banner válido.  (Si no tienes deja en blanco el campo). El banner debe ser menor de"; // 4.0
$LNG['join_error_back'] = "Por favor vuelve atrás y coloca la información necesaria.";
...
$LNG['join_changewarning'] = "Si cambias el código puede que no funcione.";
...
$LNG['stats_error_id'] = "ID inválida."; // 4.0
...
$LNG['a_edit_password_blank'] = "Deja en blanco para mantener la actual contraseña"; // 4.0
...
$LNG['a_edit_error_id'] = "ID inválida.";
$LNG['a_edit_error'] = "Error";
$LNG['a_edit_error_forgot'] = "Olvidaste:";
$LNG['a_edit_error_url'] = "Colocar una URL válida.";
$LNG['a_edit_error_email'] = "Escribiru una dirección de correo válida.";
$LNG['a_edit_error_title'] = "Escribir un título para el sitio web.";
$LNG['a_edit_error_password'] = "Escoger Contraseña.";
$LNG['a_edit_error_back'] = "Vuelve atrás y llena correctamente los campos.";
$LNG['a_edit_success'] = "¡Éxito!";
$LNG['a_edit_info_edited'] = "La información del miembro ha sido editada.";
...
$LNG['a_email_not_sent'] = "El correo no se pudo enviar a "; // 4.2.0
$LNG['a_email_msg_sent'] = "El mensaje ha sido enviado a "; // 4.2.0
...
// Admin > Login
$LNG['a_login_invalidpw'] = "¡Contraseña Inválida!";
$LNG['a_login_session'] = "La sesión ha expirado, por favor <a href=\"admin.php\">Clickea aquí</a> para loguearte de nuevo."; // 4.1.0
...
$LNG['a_menu_manage'] = "Control de miembros"; // 4.2.0
$LNG['a_menu_reset'] = "Resetear estadísticas"; // 4.1.0
$LNG['a_menu_settings'] = "Configuración";
$LNG['a_menu_settings_general'] = "General"; // 4.2.0
$LNG['a_menu_settings_skins'] = "Temas"; // 4.2.0
$LNG['a_header_members'] = "Miembros"; // 5.0
$LNG['a_header_settings'] = "Configuración"; // 5.0
$LNG['a_header_reviews'] = "Comentarios"; // 5.0

// Admin > Reset
$LNG['a_reset_confirm'] = "Esto borrará todas las estadísticas. *Esto no borrará a los miembros, sólo reseteará las estadísticas a 0."; // 4.1.0
$LNG['a_reset_stats'] = "Resetear Estadísticas"; // 4.1.0
$LNG['a_reset_done'] = "Las estadísticas de todos los miembros han sido reseteadas a 0."; // 4.1.0
...
$LNG['a_s_path'] = "El path completo al directorio del Top";
$LNG['a_s_list_url'] = "URL del directorio del Top";
$LNG['a_s_skins_path'] = "El path completo al directorio de skins"; // 4.2.0
$LNG['a_s_skins_url'] = "URL al directorio de los skins"; // 4.2.0
...
$LNG['a_s_ad_breaks'] = "Mostrar espacios despues de estas posiciones (separar con comas)";
...
$LNG['a_s_email_admin_on_join'] = "¿Enviarte un correo cuando un nuevo miembro se inscriba?";
...
$LNG['a_s_ranks_on_buttons'] = "¿Deseas que aparezca la posición (rank) de tus miembros en su botón? Lee <a href=\"http://www.aardvarkind.com/topsitesphp/manual/\" target=\"_blank\">el manual</a> para más detalles.
Sólo elige Botones de Estado si tu ya has leído la sección del manual. Si tu eliges Botones de Estado, el resto de esta sección no tendrá efecto."; // 4.2.0
...
$LNG['a_s_searchs'] = "Configuraciones de Búsqueda"; // 4.0
$LNG['a_s_search_id'] = "<a href=\"http://www.searchtraffic.com/wsignup.php3?atsphp\" target=\"_blank\">SearchTraffic</a> Affiliate ID - Ver el manual para más detalles"; // 4.2.0
$LNG['a_s_search'] = "¿Activar opción de Búsqueda?";
$LNG['a_s_searchresults'] = "Número de resultados por página de la búsqueda";

$LNG['a_s_other'] = "Otras Configuraciones";
$LNG['a_s_gzip'] = "Activar gzip - gzip ahorra ancho de banda pero consume un poco más de recursos del PC";
...
$LNG['a_s_captcha'] = "Activar palabra de verificación ( más seguridad contra spammers)"; // 4.2.2
...
// Admin > Skin Settings
$LNG['a_s_tmpl_default_skin'] = "Skin por Defecto"; // 4.2.0
$LNG['a_s_tmpl_diff_skins'] = "Si tu deseas diferentes skins para diferentes categorías, cámbialas a continuación. Para información acerca de agregar categorías y skins, visita <a href=\"http://www.aardvarkind.com/topsitesphp/manual/\" target=\"_blank\">el manual</a>."; // 4.2.0

// Admin > Version Check
$LNG['a_version_your'] = "Tu versión";
$LNG['a_version_latest'] = "Última Versión";
