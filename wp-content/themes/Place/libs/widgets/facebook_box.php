...
class Facebook_Like_Widget extends WP_Widget {
	...
	function Facebook_Like_Widget() {
		$widget_ops = array('classname' => 'facebook_like_box', 'description' => 'Add a Facebook Like box to sidebar');
		$control_ops = array('id_base' => 'facebook-like-widget');
		$this->WP_Widget('facebook-like-widget', '&rArr; PressLayer: Facebook Like Box', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		<div class="fb_inner_wrapper">
		<iframe src="http://www.facebook.com/plugins/likebox.php?href=<?php echo urlencode($page_url); ?>&amp;width=300&amp;colorscheme=light&amp;border_color=white&amp;show_faces=<?php echo $show_faces; ?>&amp;stream=false&amp;header=false&amp;height=260"  style="border:none!important; overflow:hidden; width:300px; height: 260px; margin-left:-11px; margin-bottom:-30px; margin-top:-1px; " ></iframe>
		</div>
		</div>
	...
	function form($instance)
	{
		...
		<p>
			...
			<input class="widefat" style="width: 216px;" id="<?php echo $this->get_field_id('page_url'); ?>" name="<?php echo $this->get_field_name('page_url'); ?>" value="<?php echo $instance['page_url']; ?>" type="text" />
		</p>
