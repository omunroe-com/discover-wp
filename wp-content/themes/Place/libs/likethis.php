...
function printLikes($post_id) {
	...
	if(isset($_COOKIE["like_" . $post_id])) {
	print '<a href="#" class="likeThis done" id="like-'.$post_id.'">'.$likes.'</a>';
		return;
	} //if

	print '<a href="#" class="likeThis" id="like-'.$post_id.'">'.$likes.'</a>';
} //printLikes
...
global $wpdb;
 ...
 <?php endif; 
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo $this->get_field_id('numberOfPostsToShow'); ?>"><?php _e('Number of Posts to Show:','presslayer'); ?></label> 
