...
function comment_list( $comment, $args, $depth ) {
	...
	<li class="post pingback">
		<p><?php _e( 'Pingback:', 'presslayer' ); ?> <?php comment_author_link(); ?> | <?php edit_comment_link( __( 'Editar', 'presslayer' ), '<span class="edit-link">', '</span>' ); ?></li>
	<?php
			break;
		default :
	?>
	<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
		<div class="comment_context">
			...
			<div class="comment_content">
				...
				<?php edit_comment_link( __( 'Editar', 'presslayer' ), '<span class="edit-link">', '</span>' ); ?>
				<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Responder', 'presslayer' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?></div>
				</div>
