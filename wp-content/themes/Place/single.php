	...
	<div class="inner">
		<div class="post_item post_single white_box">
			...
			<?php 
				...
				<div class="large_thumb thumb_hover">
						<div class="icon_bar for_link">
							<a href='javascript:TellAFriend_OpenForm("TellAFriend_BoxContainer","TellAFriend_BoxContainerBody","TellAFriend_BoxContainerFooter");' rel="bookmark" title="<?php the_title_attribute(); ?>" class="icon link"></a>
			...
			<div class="post_meta">
				...
				<span class="comment"><?php comments_popup_link(__('Sin comentarios','presslayer'), __('1 Comment','presslayer'), __('% Comentarios','presslayer'),'post_comment'); ?></span>
