...
function TellAFriend()
{
    ...
    ?>
    <a href='javascript:TellAFriend_OpenForm("TellAFriend_BoxContainer","TellAFriend_BoxContainerBody","TellAFriend_BoxContainerFooter");' class='icon hearth' ><?php echo get_option('TellAFriend_Caption'); ?></a>
    <div style="display: none;" id="TellAFriend_BoxContainer">
        <div id="TellAFriend_BoxContainerHeader">
            ...
            <div id="TellAFriend_BoxClose"><a href="javascript:TellAFriend_HideForm('TellAFriend_BoxContainer','TellAFriend_BoxContainerFooter');">Cerrar</a></div>
        </div>
...
function TellAFriendWindow()
{
    ...
    <div style="display: none;" id="TellAFriend_BoxContainer">
        ...
        <div id="TellAFriend_BoxContainerBody">
            <form action="#" name="TellAFriend_Form" id="TellAFriend_Form">
                <div id="TellAFriend_BoxAlert"> <span id="TellAFriend_alertmessage"></span> </div>
                <div id="TellAFriend_BoxLabel"> Tu Nombre </div>
                <div id="TellAFriend_BoxLabel">
                    <input name="TellAFriend_name" class="TellAFriend_TextBox" type="text" id="TellAFriend_name" maxlength="120">
                </div>
                <div id="TellAFriend_BoxLabel"> Correo de destino </div>
                <div id="TellAFriend_BoxLabel">
                    <input name="TellAFriend_email" class="TellAFriend_TextBox" type="text" id="TellAFriend_email" maxlength="120">
                </div>
                <div id="TellAFriend_BoxLabel"> Mensaje </div>
                <div id="TellAFriend_BoxLabel">
                    <textarea name="TellAFriend_message" class="TellAFriend_TextArea" rows="3" id="TellAFriend_message"></textarea>
                </div>
                <div id="TellAFriend_BoxLabel">
                    <input type="button" name="button" class="TellAFriend_Button" value="Enviar" onClick="javascript:TellAFriend_Submit(this.parentNode,'<?php echo get_option('siteurl'); ?>/wp-content/plugins/wp-tell-a-friend-popup-form/');">
                </div>
                <input type="hidden" name="TellAFriend_Link" id="TellAFriend_Link" value="<?php the_permalink() ?>"  />
            </form>
        </div>
    </div>
    <div style="display: none;" id="TellAFriend_BoxContainerFooter"></div>
...
function TellAFriend_shortcode( $atts ) 
{
	...
	$html = "<a href='".$open."'  class='icon hearth''>".$TellAFriend_Caption."</a>";
