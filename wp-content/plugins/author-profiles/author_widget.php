 ...
 * Description: This plugin is developed to display the list of author in your sidebar using the Widget area. The Plugin used the tabular format system in which you can add any number of columns depending upon the sidebar width.You can exclude the some authors which you do no want to display in the sidebar widgets just by typing the author name separated by comma. eg:sam,sabir in the column.

Additionally each author has a link which links to the author post page. It display all the post which is posted by Author.
