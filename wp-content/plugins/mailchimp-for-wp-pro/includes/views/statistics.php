<div id="mc4wp-statistics">
	...
	<form method="get">
		<div class="tablenav top">
			<div class="alignleft actions">
				<input type="hidden" name="page" value="mc4wp-pro-statistics" />
	...
	<div id="mc4wp-graph-summary">
		<p>Total sign-ups in shown period: <?php echo $total_signups; ?></p>
		<p>Total form sign-ups in shown period: <?php echo $total_form_signups; ?></p>
		<p>Total checkbox sign-ups in shown period: <?php echo $total_checkbox_signups; ?></p>
	</div>
